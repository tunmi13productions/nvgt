...
void RegisterSoundsystemNodes(asIScriptEngine *engine) {
	...
	RegisterSoundsystemAudioNode <plate_reverb_node> (engine, "audio_plate_reverb_node");
	engine->RegisterObjectBehaviour("audio_plate_reverb_node", asBEHAVE_FACTORY, "audio_plate_reverb_node@ n(audio_engine@ engine = sound_default_engine)", asFUNCTION(plate_reverb_node::create), asCALL_CDECL);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_predelay(float seconds) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_predelay, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_predelay() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_predelay, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_bandwidth(float bandwidth) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_bandwidth, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_bandwidth() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_bandwidth, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_decay(float decay) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_decay, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_decay() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_decay, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_damping(float damping) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_damping, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_damping() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_damping, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_size(float size) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_size, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_size() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_size, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_input_diffusion_1(float diffusion) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_input_diffusion_1, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_input_diffusion_1() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_input_diffusion_1, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_input_diffusion_2(float diffusion) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_input_diffusion_2, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_input_diffusion_2() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_input_diffusion_2, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_decay_diffusion_1(float diffusion) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_decay_diffusion_1, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_decay_diffusion_1() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_decay_diffusion_1, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_decay_diffusion_2(float diffusion) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_decay_diffusion_2, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_decay_diffusion_2() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_decay_diffusion_2, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_modulation_depth(float depth) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_modulation_depth, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_modulation_depth() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_modulation_depth, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_modulation_rate(float hz) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_modulation_rate, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_modulation_rate() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_modulation_rate, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_wet(float wet) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_wet, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_wet() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_wet, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_dry(float dry) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_dry, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_dry() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_dry, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_width(float width) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_width, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "float get_width() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_width, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "void set_frozen(bool frozen) property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::set_frozen, void, bool >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "bool get_frozen() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_frozen, bool >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_plate_reverb_node", "uint get_decay_time_in_frames() const property", asFUNCTION((virtual_call < plate_reverb_node, &plate_reverb_node::get_decay_time_in_frames, unsigned int >)), asCALL_CDECL_OBJFIRST);
	RegisterSoundsystemAudioNode <convolution_reverb_node> (engine, "audio_convolution_reverb_node");
	engine->RegisterObjectBehaviour("audio_convolution_reverb_node", asBEHAVE_FACTORY, "audio_convolution_reverb_node@ n(audio_engine@ engine = sound_default_engine, uint partition_size = 1024)", asFUNCTION(convolution_reverb_node::create), asCALL_CDECL);
	engine->RegisterObjectMethod("audio_convolution_reverb_node", "bool load_ir(const string&in filename, const pack_interface@+ pack_file = sound_default_pack)", asFUNCTION((virtual_call < convolution_reverb_node, &convolution_reverb_node::load_ir, bool, const string&, const pack_interface* >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_convolution_reverb_node", "void clear_ir()", asFUNCTION((virtual_call < convolution_reverb_node, &convolution_reverb_node::clear_ir, void >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_convolution_reverb_node", "bool get_ir_loaded() const property", asFUNCTION((virtual_call < convolution_reverb_node, &convolution_reverb_node::get_ir_loaded, bool >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_convolution_reverb_node", "uint64 get_ir_length_frames() const property", asFUNCTION((virtual_call < convolution_reverb_node, &convolution_reverb_node::get_ir_length_frames, unsigned long long >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_convolution_reverb_node", "float get_ir_length_ms() const property", asFUNCTION((virtual_call < convolution_reverb_node, &convolution_reverb_node::get_ir_length_ms, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_convolution_reverb_node", "void set_wet(float wet) property", asFUNCTION((virtual_call < convolution_reverb_node, &convolution_reverb_node::set_wet, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_convolution_reverb_node", "float get_wet() const property", asFUNCTION((virtual_call < convolution_reverb_node, &convolution_reverb_node::get_wet, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_convolution_reverb_node", "void set_dry(float dry) property", asFUNCTION((virtual_call < convolution_reverb_node, &convolution_reverb_node::set_dry, void, float >)), asCALL_CDECL_OBJFIRST);
	engine->RegisterObjectMethod("audio_convolution_reverb_node", "float get_dry() const property", asFUNCTION((virtual_call < convolution_reverb_node, &convolution_reverb_node::get_dry, float >)), asCALL_CDECL_OBJFIRST);
