...
LOCAL_SRC_FILES_COMMON := \
    ...
    ../dep/cmp.c ../dep/entities.cpp ../dep/ma_convolution_node.c ../dep/ma_plate_node.c ../dep/ma_reverb_node.c ../dep/micropather.cpp ../dep/miniaudio_libopus.c ../dep/miniaudio_libvorbis.c ../dep/miniaudio_phonon.c ../dep/miniaudio_wdl_resampler.cpp ../dep/monocypher.c ../dep/resample.cpp ../dep/rng_get_bytes.c ../dep/singleheader.cpp ../dep/sonic.c ../dep/tonar.c ../dep/uncompr.c\
